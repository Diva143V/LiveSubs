...
namespace LIveSubs.models
{
    public class Setting : INotifyPropertyChanged
    {
        ...
        private bool enableTranslationHistory = false;
        ...
        public bool EnableTranslationHistory
        {
            get => enableTranslationHistory;
            set
            {
                enableTranslationHistory = value;
                OnPropertyChanged("EnableTranslationHistory");
            }
        }
        ...
        private static string GetSettingsPath()
        {
            ...
            string appFolder = Path.Combine(appData, "LiveSubs");
        ...
        {
            string jsonPath = GetSettingsPath();
            try
            {
        ...
        public static Setting Load(string jsonPath)
        {
            ...
            foreach (string key in TranslateAPI.TRANSLATE_FUNCTIONS.Keys)
            {
                if (setting.Configs.ContainsKey(key))
                    continue;
                var configType = Type.GetType($"LIveSubs.models.{key}Config");
