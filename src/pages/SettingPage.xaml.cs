    ...
    public partial class SettingPage : Page
    {
        ...
        private async void TestConnectionButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var translateFunc = TranslateAPI.TranslateFunction;
                string result = await translateFunc("Hello", System.Threading.CancellationToken.None);
                sw.Stop();

                if (result.Contains("[ERROR]"))
                {
                    SnackbarHost.Show("Test Failed",
                        result.Replace("[ERROR] ", ""),
                        SnackbarType.Error, 400, 3);
                }
                else
                {
                    SnackbarHost.Show("Test Passed ✓",
                        $"Result: \"{result}\"  •  Latency: {sw.ElapsedMilliseconds}ms",
                        SnackbarType.Success, 400, 3);
                }
            }
        ...
        private void LiveCaptionsInfo_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            LiveCaptionsInfoFlyout.Show();
        }

        private void LiveCaptionsInfo_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
            LiveCaptionsInfoFlyout.Hide();
        }

        private void FrequencyInfo_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            FrequencyInfoFlyout.Show();
        }

        private void FrequencyInfo_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
            FrequencyInfoFlyout.Hide();
        }

        private void TranslateAPIInfo_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            TranslateAPIInfoFlyout.Show();
        }

        private void TranslateAPIInfo_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
            TranslateAPIInfoFlyout.Hide();
        }

        private void TargetLangInfo_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            TargetLangInfoFlyout.Show();
        }

        private void TargetLangInfo_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
            TargetLangInfoFlyout.Hide();
        }

        private void CaptionLogMaxInfo_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            CaptionLogMaxInfoFlyout.Show();
        }

        private void CaptionLogMaxInfo_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
            CaptionLogMaxInfoFlyout.Hide();
        }

        private void ContextAwareInfo_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            ContextAwareInfoFlyout.Show();
        }

        private void ContextAwareInfo_MouseLeave(object sender, System.Windows.Input.MouseEventArgs e)
        {
