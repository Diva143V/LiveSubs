...
namespace LIveSubs
{
    public partial class HistoryPage : Page
    {
        ...
        {
            var dialogHostContainer = (System.Windows.Application.Current.MainWindow as MainWindow)?.DialogHostContainer;
        ...
        private async void Export_click(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                ...
                {
                    SnackbarHost.Show("Save Failed.", $"File saved failed: {ex.Message}", SnackbarType.Error);
                }
            }
        }
