...
namespace LIveSubs.utils
{
    public static class SQLiteHistoryLogger
    {
        ...
        /// <summary>
        /// Lazily initialize the database, respecting the user's setting.
        /// Returns true if history should be used, false if disabled.
        /// </summary>
        private static bool EnsureInitialized()
        {
            ...
            // If settings are not loaded yet or user disabled history, skip DB creation.
            if (Translator.Setting != null && !Translator.Setting.EnableTranslationHistory)
                return false;
        ...
        {
            if (!EnsureInitialized())
                return (new List<TranslationHistoryEntry>(), 1);
